...
openMap true;
hint "Kattints a térképen a kiindulási pozícióra!";
onMapSingleClick {
    ...
    private _markerText = format ["START - %1", groupId group player];
    ...
    hint "Kattints a térképen a kiugrási pozícióra!";
    onMapSingleClick {
        ...
        private _markerText = format ["UGRÁSI ZÓNA - %1", groupId group player];
        ...
        hint "Határozd meg az ugrási magasságot!";
        ...
        _okButton ctrlSetText (format ["Ugrási magasság %1 m", _altFullForce]);
        ...
        _slider ctrlAddEventHandler ["SliderPosChanged", {
            ...
            private _okButton = (findDisplay 7777) displayCtrl 1;
            _okButton ctrlSetText format ["Ugrási magasság %1 m", _newValue];
