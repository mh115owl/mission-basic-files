...
class ffr_altitude_menu {
    ...
    class controls {
        ...
        {
        	idc = 1900;
        	text = "Ugrási magasság"; //--- ToDo: Localize;
        ...
        class ffr_altitude_ok: RscButtonMenuOK
        {
            ...
            action = "private _mkr = (missionNamespace getVariable 'ffr_ai_rpMarker'); _mkr setMarkerText format ['%1 - %2 m', markerText _mkr, ffr_ai_alt]; hint 'Repülési terv beállítva'; ffr_aiFlightReady = true;";
        };
    };
};
