...
if (hasInterface) then {
    titleCut ["", "BLACK"];
    titleText ["Felszállás után nem sokkal...", "PLAIN", 0.5];
    titleCut ["", "BLACK in", 5];
};
...
private _waypointStatements = {
    _a = vehicle this;
    _a vehicleChat 'Vörös jelzés! Állj fel, AMINT UTASÍTANAK RÁ és ellenőrizd a felszerelésedet!';
...
_wp setWaypointStatements ["true", "_a = vehicle this; _a vehicleChat 'Zöld jelzés! Ugrás! Ugrás! Ugrás!'; ['ffr_main_setJumplight', [_a, 'green']] call CBA_fnc_globalEvent;"];
